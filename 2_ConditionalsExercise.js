...
function exercise1(num1) {
    let answer1 = "num is small"; // initialized variable with new string
    // ------------------------------------------
    // Write your code for exercise 1 below here:
    // ------------------------------------------
  if (num1 > 10) {

    answer1 = "The value is" + " " + num1 + " and is greater than 10" // add space via " " when concateing
  }
    // ------------------------------------------
    // And above here
    // ------------------------------------------
  ...
  console.log(exercise1(8)); //test cases
  ...
  function exercise2(num2) {
    ...
    // --------------------------------------------
  /* use a modulu operator to determine if interger is even or odd */
   if ((num2 % 2 ) == 0) {
  ...
  console.log(execise2(3));
  console.log(execise2(8));
  ...
  console.log(execise3(-8));
  console.log(execise3(8));
  console.log(execise3(0));
  ...
  function exercise4(varA, varB) {
    ...
    if (varA == varB) {
      ...
      let answer4 = "varaA and varB differ"
   }
    // --------------------------------------------
    // And above here
    // --------------------------------------------
  ...
  console.log(excercise4 ("String", false));
  ...
  // Answer: When the data types differ despite values being the same. An example of this is "null" which is a string versus null which is a boolean.
  ...
  function exercise6(varA, varB, varC) {
    ...
    if ((varA == varB) && (varA =! varC || varB !== varC)) { // value in p1 must equal value of p2 use && operator to include expression for p1 or p2 not equalin in value to p3 
    answer6 = true;
  ...
  console.log(exercise6(3,2,1));
  console.log(exercise6(2,1,1));
...
function exercise8(amount1, amount2, minimum, maximum) {
  ...
  if (amount1 < minimum && amount1 > maximum && amount2 < minimum && amount2 > maximum) {
    ...
    // And above here
    // --------------------------------------------
    console.log(exercise8(2,8,1,9));
    console.log(exercise8(1,2,1,9));
 ...
 if (typeof(item) == Number) {
    ...
    switch (item) {
     ...
     answer9 = "Please send me a number, that was a " + typeof(item) + ".";
   }
    return answer9;
    } 
  ...
  console.log(exercise10(12));
  console.log(exercise10(30));
  console.log(exercise10(20));


    // Congrats, you made it to the end! You rock!
  // Did you find this easy or hard? If you used references, which ones helped you?

    //I am always mispelling variables and losing track of curly brackets. I think I just need to code more.
